                ...
                <a href="#none" target="_blank" title="새 창 열림">
                    ...
                    <div class="hero-tit left top"><!-- left / center / right --><!-- mobile : top / bottom --> <!-- default(white) : #fff / .black : #000 -->
                        <div class="hero-tit-detail">
                            ...
                            <div class="cta">
                                <button type="button" class="btn border s02 hero" onclick="window.open('#')">자세히 보기</button>
                            </div>
                        </div>
                    </div>
                </a>
                ...
                <a href="#none" target="_blank" title="새 창 열림">
                    <div class="hero-tit left top"><!-- pc : left / center / right --> <!-- mobile : top / bottom --> <!-- default(white) : #fff / .black : #000 -->
                        <div class="hero-tit-detail">
                            ...
                            <div class="cta">
                                <button type="button" class="btn border s02 hero" onclick="window.open('#')">자세히 보기</button>
                                <button type="button" class="btn-view" onclick="window.open('#')">자세히 보기</button>
                                <button type="button" class="btn-video-view" onclick="window.open('#')">영상보기</button>
                            </div>
                        </div>
                    </div>
