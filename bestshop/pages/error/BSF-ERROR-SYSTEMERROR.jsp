                ...
                <div class="contents no-header">
                    ...
                    <div class="cont-wrap">
                        <div class="err-msg-area">
                            ...
                            <div class="err-msg-big">
                                <strong>이용에 불편을 드려 죄송합니다</strong>
                            </div>

                            <div class="err-msg-small">
                                <span>요청하신 페이지가 정상적으로 처리되지 않았습니다.</span>
                            </div>

                            <div class="err-msg-gray">
                                <span>해당 요청사항 처리 중 일시적 점검 등의 이유로 <br class="pc-hidden">페이지가 정상적으로 서비스되지 않습니다.</span>
                                <span>잠시 후 다시 시도해 주시기 바랍니다.</span>
                            </div>
