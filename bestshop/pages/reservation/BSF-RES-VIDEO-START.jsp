    ...
    <body>
        <div class="wrap">
            <div class="container" id="content">
                ...
                <div class="contents res-video-mobile">

                    <div class="title">
                        <h1 class="logo">
                            <img src="/bestshop/images/icons/logo-lge.svg" alt="LG전자"><span>BEST SHOP</span>
                        </h1>
                        <em>화상 상담 서비스</em>
                    </div>
                    ...
                    <div class="cont-area">
                        <p class="txt">
                            <strong>안녕하세요 고객님, <br>LG베스트샵 화상 상담 서비스입니다.</strong>
                            <span>아래 ‘화상 상담 시작하기’ 버튼을 터치하신 후 <br>화상 상담을 진행해주시기 바랍니다.</span>
                        </p>
                    </div>
