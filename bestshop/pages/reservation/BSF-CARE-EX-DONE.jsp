            ...
            <div class="cont-wrap w100">
                <div class="done-msg-area">
                    ...
                    <div class="done-msg-small">
                        <ul>
                            <li>* 담당 매니저가 선정된 후, 매장 방문일 확인을 위해 <br class="only_mo">입력하신 휴대폰 번호로 연락드릴 예정이니 참고 부탁드립니다.
                            </li>
                            <li>* 상담 예약 내역 조회는'매장 상담 예약 > 상담예약 조회' 화면에서 <br class="only_mo">확인하실 수 있습니다.</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="info-box">
                        <ul>
                            ...
                            <li>
                                ...
                                <strong>
                                    물걸레노즐 (VNZPM02N)<br>
                                    트루 토탈케어 필터 전용 극세 필터 (PFPDNC06)<br>
                                    드럼 원터치급수호스(1.25M 온수) (WMFLHOSE4)
                                </strong>
                            </li>
                            <li>
                                <span>예약자 정보</span>
