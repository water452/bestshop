    ...
    <div class="contents res-main">
        ...
        <div class="cont-wrap">
            ...
            <div class="inq-area">
                ...
                <div class="no-data">
                    <p>조회된 상담 예약 내역이 없습니다.</p>
                </div>

                <div class="caution-box">
                    <p class="tit">&lsqb;유의사항&rsqb;</p>
                    <ul class="bull">
                        <li>최근 6개월의 예약 결과를 조회 하실 수 있으며, 예약 결과가 조회되지 않는 경우 02-3777-1114로 문의하시기 바랍니다.</li>
                        <li>신청하신 예약일 당일에는 취소가 불가합니다.</li>
                        <li>상담 예약 일시 변경이 필요하신 경우 상담매장에 연락 주시기 바랍니다.</li>
                    </ul>
                </div>
