                                ...
                                <ul class="col-2">
                                    ...
                                    <li>
                                        ...
                                        <div class="desc-wrap">
                                            <dl>
                                                <dt>토탈 클리닝 서비스</dt>
                                                <dd>먼지가 축적되면 제품 성능에 영향을 줄 수 있습니다. 필터 장착부를 포함한 제품 내/외부의 클리닝은 물론 세척제를 이용해
                                                    2중 안심필터, 배수통, 스팀 물통을 세척하고 습도센서까지 점검&middot;관리해드립니다.</dd>
                                            </dl>
                                        </div>
                                    </li>
                                    <li>
                                        ...
                                        <div class="desc-wrap">
                                            <dl>
                                                <dt>섬유유연시트 무상 증정</dt>
                                                <dd>방문 시마다 건조기 전용 섬유유연시트(LG 생활건강 아우라 드라이)를 제공해 따로 구매하는 번거로움과 비용 부담이
                                                    없습니다.</dd>
                                            </dl>
                                        </div>
                                    </li>
