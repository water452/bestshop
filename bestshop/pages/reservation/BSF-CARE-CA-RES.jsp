...
<div class="container" id="content">
  ...
  <div class="contents res-main care">
    ...
    <div class="top-wrap">
      ...
      <div class="swiper care-banner">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="banner-box">
              <img class="only_pc" src="../../images/img-careship-banner-01.jpg" alt="케어십 상담 예약 배너 이미지">
              <img class="only_mo" src="../../images/img-careship-banner-01_mo.jpg" alt="케어십 상담 예약 배너 이미지">
            </div>
          </div>
          <div class="swiper-slide">
            <div class="banner-box">
      ...
      <section class="cont-area">
          ...
          <div class="main-area active"><!-- active 클래스 추가 -->
            ...
            <div class="service-detail-area water">
              ...
              <ul class="col-3">
                <li>
                  <div class="icon-wrap">
                    <img src="../../images/icons/icon-care-water-01.svg" alt="">
                  </div>
                  <div class="desc-wrap">
                    <dl>
                      <dt>출수구 살균</dt>
                ...
                <li>
                  <div class="icon-wrap">
                    <img src="../../images/icons/icon-care-water-02.svg" alt="">
                  </div>
                  <div class="desc-wrap">
                    <dl>
                      <dt>필터 무상 교체</dt>
                ...
                <li>
                  <div class="icon-wrap">
                    <img src="../../images/icons/icon-care-water-03.svg" alt="">
                  </div>
                  <div class="desc-wrap">
                    <dl>
                      <dt>외관 토탈 클리닝</dt>
            ...
            <div class="service-detail-area dryer">
              ...
              <ul class="col-2">
                <li>
                  <div class="icon-wrap">
                    <img src="../../images/icons/icon-care-dryer-01.svg" alt="">
                  </div>
                  <div class="desc-wrap">
                    <dl>
                      <dt>2중 안심필터 무상 증정</dt>
                ...
                <li>
                  <div class="icon-wrap">
                    <img src="../../images/icons/icon-care-dryer-02.svg" alt="">
                  </div>
                  <div class="desc-wrap">
                    <dl>
                      <dt>토탈 클리닝 서비스</dt>
                ...
                <li>
                  <div class="icon-wrap">
                    <img src="../../images/icons/icon-care-dryer-03.svg" alt="">
                  </div>
                  <div class="desc-wrap">
                    <dl>
                      <dt>섬유유연시트 무상 증정</dt>
                ...
                <li>
                  <div class="icon-wrap">
                    <img src="../../images/icons/icon-care-dryer-04.svg" alt="">
                  </div>
                  <div class="desc-wrap">
                    <dl>
        ...
        <div class="step-area step03 active"><!-- active 클래스 추가 -->        
          ...
          <div class="btn-area active"><!-- active 클래스 추가 -->
            <button type="button" class="btn btn-res">케어십 상담 예약하기</button>
          </div>
...
<script>
  $(document).ready(function(){
    // 배너
    var careBanner = new Swiper(".care-banner", {
      spaceBetween: 40,
      navigation: {
