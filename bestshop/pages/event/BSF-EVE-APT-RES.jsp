...
<div class="container" id="content">
    <div class="page-header">
        <h2 class="title">입주 이벤트 방문 상담 예약</h2>
        <div class="desc">
            <p class="txt">개포 더샵 트리에</p>
        </div>
    </div>
    <!-- contents -->
                                                    ...
                                                    <div class="inner custom-scroll">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                ...
                                                                <p>※ 귀하께서는 위와 같은 개인정보 수집/이용에 동의하지 않을 권리가 있으며 단, 거부하신 경우 매장 상담신청 참여가 제한됩니다.</p>
                                                            </li>
                                                            <li>
            ...
            <div class="bar-wrap">
                ...
                <div class="foot-area">
                    <div class="btn-area active"><!-- active 클래스 추가 -->
                        <!-- <button type="button" class="btn btn-res btnPopOpen" data-href="#popup-certification">상담 예약하기</button> -->
                        <!-- 시연용 -->
                        <a href="BSF-EVE-APT-RES-DONE.jsp" class="btn btn-res">상담 예약하기</a>
                        <!-- //시연용 -->
                    </div>
                </div>
            </div>
...
<div class="popup medium m-full" id="popup-certification">
    <div class="pop-wrap">
        ...
        <div class="btn-area m-full-flex">
            ...
            <a href="BSF-EVE-APT-RES-DONE.jsp" class="btn">인증하기</a>
        </div>
        <button type="button" class="btn-pop-close btnPopClose"><span class="blind">닫기</span></button>
    </div>
</div>
