        ...
        <div class="cont-wrap">
            <div class="top-wrap top-visual">
                ...
                <div class="tit-img-area">
                    <img class="m-hidden" src="../../images/temp_img_event_reservation.jpg" alt="&nbsp;" /><!#-- pc용 --#>
                    <img class="pc-hidden" src="../../images/temp_img_event_reservation.jpg" alt="&nbsp;" /><!#-- mobile용 --#>
                </div>
                e : 단일 이미지 등록 case -->
...
<div class="popup medium m-full" id="popup-certification">
    <div class="pop-wrap">
        ...
        <div class="btn-area m-full-flex">
            ...
            <a href="BSF-EVE-SHOP-RES-DONE.jsp" class="btn">인증하기</a>
        </div>
        <button type="button" class="btn-pop-close btnPopClose"><span class="blind">닫기</span></button>
    </div>
</div>
