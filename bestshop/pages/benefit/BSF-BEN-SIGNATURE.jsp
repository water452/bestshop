...
<div class="container" id="content">
    ...
    <!-- contents -->
    <div class="contents res-main signature">
        ...
        <div class="cont-wrap">
            <div class="top-wrap top-visual">
                ...
                <div class="tit-img-area">
                    <!-- s : img case 
                        <img class="m-hidden" src="../../images/img_signature.jpg" alt="&nbsp;" />
                        <img class="pc-hidden" src="../../images/img_signature_mo.jpg" alt="&nbsp;" />
                    e : img case -->

                    <!-- s : video case -->
                    <div class="video-wrap">
                        <video class="pcOnly" autoplay="" playsinline="" muted="" poster="../../images/img-benefit-month-slide-test.png" class="videoPoster" loop> <!-- pc only -->
                            <source src="../../images/main_carousel_video_01.mp4" type="video/mp4">
                            <p>LG전자 회사소개 동영상</p>
                        </video>
                        <video class="mobileOnly" autoplay="" playsinline="" muted="" poster="../../images/img-benefit-month-slide-test-mo.png" class="videoPoster" loop> <!-- mobile only -->
                            <source src="../../images/main_carousel_video_01.mp4" type="video/mp4">
                            <p>LG전자 회사소개 동영상</p>
                        </video>
                    </div>
                    ...
                    <div class="swiper img-slide h-452 bdr-0">
                        <ul class="swiper-wrapper">
                            <li class="swiper-slide">
                                <div class="img-wrap">
                                    <img class="m-hidden" src="../../images/img-banner-dummy.png" alt="&nbsp;" />
                                    <img class="pc-hidden" src="../../images/img-banner-dummy-mo.png" alt="&nbsp;" />
                                </div>
                            </li>
                            <li class="swiper-slide">
                                <div class="img-wrap">
